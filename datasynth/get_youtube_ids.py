...
def main(args):
    ...
    videos = scrapetube.get_channel(channel_username=channel_name, sleep=0.1, limit=limit)
...
if __name__ == "__main__":
    ...
    ap.add_argument("-c", "--channel", required=True, help="Name of the YouTube channel")
    ap.add_argument("-o", "--outdir", required=True, help="Output Directory")
    ap.add_argument("-l", "--limit", required=False, help="Limit number of videos", type=int)
